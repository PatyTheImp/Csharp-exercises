...
namespace Tarefa_24v2
{
    class Program
    {
            ...
            do
            {
                ...
                switch (op)
                {
                    ...
                    case '4':
                        ...
                        aluno = Console.ReadLine();
                        Console.WriteLine("Número de alunos com o nome {1}: {0}", FrequenciaNome(alunos, pos, aluno), aluno);
                        op = FimFuncionalidade();
                        break;
                    ...
                    case '5':
                        if (pos > 0)
                            Console.WriteLine("O nome com mais ocorrências é: {0}", NomeFrequente(alunos, pos));
                        else
                            Console.WriteLine("Não existem alunos inscritos.");
                        op = FimFuncionalidade();
                        break;
        ...
        public static void Menu()
        {
            ...
            Console.WriteLine("Consultar nome mais frequente...................(5)");
        ...
        public static string NomeFrequente(string[] array_alunos, int posicao)
        {
            string nomeFreq = array_alunos[0];

            for (int i = 1; i < posicao; i++)
            {
                if (FrequenciaNome(array_alunos, posicao, nomeFreq) < FrequenciaNome(array_alunos, posicao, array_alunos[i]))
                    nomeFreq = array_alunos[i];
            }
